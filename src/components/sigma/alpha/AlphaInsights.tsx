...
const INSIGHTS_DATA: { title: string; date: string; tag: string; desc: string; citations: number; readTime: string; sections: { heading: string; body: string }[]; authors: string }[] = [
  {
    title: "Myanmar Mekong Archipelago Financial Center: A CBDC Blueprint",
    date: "2025.06.15", tag: "Web3", readTime: "14 min", authors: "CHAIN WEAVER, THE ARCHITECT",
    desc: "A comprehensive framework for implementing a Central Bank Digital Currency infrastructure for the proposed Myanmar Mekong Archipelago Financial Center, integrating with global cross-border payment rails.",
    citations: 9,
    sections: [
      { heading: "CONTEXT", body: "The Myanmar Mekong Archipelago Financial Center (MMAFC) initiative aims to establish a regional financial hub serving Southeast Asian cross-border trade flows. A CBDC layer is essential infrastructure — enabling instant settlement, reducing correspondent banking costs, and providing programmable money for trade finance. We present a technical blueprint that aligns with BIS Project mBridge architecture while adapting for Myanmar's regulatory framework and infrastructure constraints." },
