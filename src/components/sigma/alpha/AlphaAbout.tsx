    ...
    <section id="about" className="relative border-t border-border px-6 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <SciFiCard className="lg:col-span-2" accent="#FF4500" label="▸ MISSION" id="TSL-001">
            <div className="p-4">
          ...
          <div className="space-y-4">
            <SciFiCard accent="#00FF94" label="▸ STATS" id="LAB.v2">
              <div className="p-4">
            ...
            <SciFiCard accent="#00E5FF" label="▸ SIGMA" id="1.0000">
        ...
        <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-5">
          {capabilityData.map((cap) => (
            <SciFiCard key={cap.label} accent={cap.color} label={cap.label} id={`${cap.pct}%`}>
              <div className="p-3">
