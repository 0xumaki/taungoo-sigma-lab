...
const SERVICES = [
  { name: "AI Chatbot", icon: "◐", desc: "AI chatbots that handle real workloads — sales, support, onboarding.", price: "from 38,400,000 MMK", cat: "AI", slug: "ai-chatbot" },
  { name: "Voice AI", icon: "♫", desc: "Voice agents that close sales and resolve support tickets.", price: "from 57,600,000 MMK", cat: "AI", slug: "voice-ai" },
  { name: "Agent Swarm", icon: "⬡", desc: "Multi-agent swarms for complex, real-world workflows.", price: "from 96,000,000 MMK", cat: "AI", slug: "agent-swarm" },
  { name: "AI Automation", icon: "⚙", desc: "N8N workflows + CRM loops that run themselves.", price: "from 24,000,000 MMK", cat: "AI", slug: "ai-automation" },
  { name: "API & MCP", icon: "⌗", desc: "Custom APIs and MCP servers that integrate with anything.", price: "from 38,400,000 MMK", cat: "AI", slug: "api-mcp" },
  ...
  { name: "AI Video Generation", icon: "▶", desc: "Commercial-grade video pipelines. MVs, ads, brand content.", price: "from 7,200,000 MMK", cat: "DESIGN", slug: "ai-video-generation" },
  { name: "3D Modeling", icon: "◈", desc: "Product viz, architectural, and game-ready 3D assets.", price: "from 7,200,000 MMK", cat: "DESIGN", slug: "3d-modeling" },
  { name: "Graphic Design", icon: "◆", desc: "Brand identity, collateral, and UI kits that get remembered.", price: "from 5,800,000 MMK", cat: "DESIGN", slug: "graphic-design" },
  { name: "Content & Copywriting", icon: "✎", desc: "Technical writing, marketing copy, docs that convert.", price: "from 3,800,000 MMK", cat: "DESIGN", slug: "content-copywriting" },
  { name: "Online Media Buying", icon: "▲", desc: "Ad campaigns + media strategy with measurable ROI.", price: "from 7,200,000 MMK", cat: "DESIGN", slug: "online-media-buying" },
  { name: "UI/UX Design", icon: "◡", desc: "Product design + design systems that scale with users.", price: "from 57,600,000 MMK", cat: "DESIGN", slug: "ui-ux-design" },
  { name: "Android & iOS App", icon: "▣", desc: "Native + cross-platform apps. App Store-ready releases.", price: "from 96,000,000 MMK", cat: "FULL-STACK", slug: "android-ios-app" },
  { name: "Web / WebApp", icon: "▣", desc: "Full-stack web apps on Next.js 16 + React 19.", price: "from 48,000,000 MMK", cat: "FULL-STACK", slug: "web-webapp" },
  { name: "Chrome Extensions", icon: "⬚", desc: "Browser automation + productivity extensions. Ship in days.", price: "from 19,200,000 MMK", cat: "FULL-STACK", slug: "chrome-extensions" },
  { name: "Desktop / MacBook Apps", icon: "◱", desc: "Cross-platform desktop apps on Electron + Tauri.", price: "from 120,000,000 MMK", cat: "FULL-STACK", slug: "desktop-macbook-apps" },
  { name: "ASO", icon: "⊙", desc: "App Store Optimization that ranks. From keyword to install.", price: "from 14,400,000 MMK", cat: "FULL-STACK", slug: "aso" },
  { name: "Web3 Wallets", icon: "⬡", desc: "Non-custodial wallets with hardware-grade security.", price: "from 86,400,000 MMK", cat: "WEB3", slug: "web3-wallets" },
  { name: "AMM / DEX", icon: "⇄", desc: "AMM + DEX protocols that settle on mainnet. Audited.", price: "from 192,000,000 MMK", cat: "WEB3", slug: "amm-dex" },
  { name: "DAO Governance", icon: "◍", desc: "DAO frameworks with on-chain voting + treasury control.", price: "from 96,000,000 MMK", cat: "WEB3", slug: "dao-governance" },
  { name: "NFT Systems", icon: "✦", desc: "NFT minting + marketplace + royalty infrastructure.", price: "from 144,000,000 MMK", cat: "WEB3", slug: "nft-systems" },
  { name: "Security Audit", icon: "⚿", desc: "Smart contract audits. Catch exploits before mainnet.", price: "from 38,400,000 MMK", cat: "WEB3", slug: "security-audit" },
  { name: "Smart Contract Dev", icon: "∎", desc: "Solidity/Rust contracts shipped to mainnet. Gas-optimized.", price: "from 24,000,000 MMK", cat: "WEB3", slug: "smart-contract-development" },
  { name: "RWA Development", icon: "▣", desc: "Real-world asset tokenization + white-label RWA platform licensing", price: "from 192,000,000 MMK", cat: "WEB3", slug: "rwa-development" },
  { name: "Money Market Development", icon: "$", desc: "DeFi lending, borrowing, and yield protocols.", price: "from 216,000,000 MMK", cat: "WEB3", slug: "money-market-development" },
  { name: "Stablecoin Development", icon: "₵", desc: "Banking-grade stablecoin infrastructure at institutional scale.", price: "from 144,000,000 MMK", cat: "WEB3", slug: "stablecoin-development" },
  { name: "Mobile/Web Game Dev", icon: "◆", desc: "Mobile + web games on Unity, Phaser, and WebGL.", price: "from 72,000,000 MMK", cat: "FULL-STACK", slug: "mobile-web-game-development" },
];
