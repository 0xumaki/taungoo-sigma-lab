...
const LOGS: LogEntry[] = [
  ...
  { kind: "DATASET", title: "Taungoo Community Voice Corpus (v2)", id: "TSL-DS-003", date: "2024.09.18", authors: "SIGNAL TENDER", abstract: "4-language voice corpus recorded with the local Myanmar community under Helsinki-Trust partnership model.", size: "1.4GB", doi: "10.48550/TSL.DS.003", citations: 2, downloads: 89, keywords: ["voice corpus", "myanmar", "NLP", "community"], fullAbstract: "A 4-language (Burmese, Karen, Yangon dialect, English) voice corpus containing 18,400 annotated utterances recorded with the local Myanmar community under the Helsinki-Trust partnership model. All speakers consented under a community-benefit agreement. The corpus includes phoneme-level alignments, speaker demographics (anonymized), and environmental metadata. Released under CC-BY-SA-NC with a community-royalty clause.", references: 12, status: "OPEN" },
  ...
  { kind: "PAPER", title: "Local-Language NLP for Low-Resource Myanmar Dialects", id: "TSL-2024-005", date: "2024.04.22", authors: "SIGNAL TENDER", abstract: "A tokenizer and adapter stack for Yangon-region dialects, evaluated on community-authored eval sets.", size: "11pp", doi: "10.48550/TSL.2024.005", citations: 11, downloads: 389, keywords: ["NLP", "myanmar", "low-resource", "tokenizer"], fullAbstract: "We present a tokenizer and adapter stack for Yangon-region Myanmar dialects, addressing the low-resource NLP gap. Our approach combines a phoneme-aware subword tokenizer with a dialect-adapter fine-tuning protocol. We release the first community-authored eval set for Yangon dialects (2,400 sentences) and show 18% F1 improvement over the baseline mBERT model. All data and models are released under CC-BY-SA.", references: 38, status: "PUBLISHED" },
  { kind: "PAPER", title: "Zero-Knowledge Proof Systems for Non-Custodial Wallets", id: "TSL-2024-008", date: "2025.01.15", authors: "CHAIN WEAVER, NULL CIPHER", abstract: "ZK-proof architecture for non-custodial wallet verification without exposing private keys.", size: "14pp", doi: "10.48550/TSL.2024.008", citations: 5, downloads: 198, keywords: ["ZK proofs", "wallets", "cryptography", "privacy"], fullAbstract: "We present a zero-knowledge proof architecture for non-custodial wallet verification that allows third-party auditors to verify wallet solvency without exposing private keys or transaction history. The system uses Groth16 proofs with a modified Pedersen commitment scheme, achieving 0.3s proof generation and 0.01s verification on commodity hardware. We demonstrate integration with two production wallets (Crystal Wallets and Sai Pay), showing no user-facing latency increase.", references: 22, status: "PUBLISHED" },
  { kind: "DATASET", title: "DeFi Transaction Corpus (Mainnet + Testnet)", id: "TSL-DS-004", date: "2025.02.08", authors: "CHAIN WEAVER, EDGE RUNNER", abstract: "1.2M labeled DeFi transactions across 6 chains with MEV classification.", size: "480MB", doi: "10.48550/TSL.DS.004", citations: 3, downloads: 267, keywords: ["DeFi", "transactions", "MEV", "dataset"], fullAbstract: "A comprehensive dataset of 1.2 million labeled DeFi transactions across 6 blockchains (Ethereum, BSC, Polygon, Arbitrum, Optimism, Avalanche). Each transaction includes: sender/receiver (anonymized), value, gas, timestamp, MEV classification (front-run, back-run, sandwich, arbitrage, liquidation), and smart contract interaction trace. The corpus enables research into MEV detection, transaction clustering, and DeFi user behavior analysis. Released under CC-BY-SA-NC.", references: 8, status: "OPEN" },
  { kind: "BLUEPRINT", title: "Agent Swarm Orchestration Protocol v3", id: "TSL-BP-015", date: "2025.02.20", authors: "NEURAL HAND, THE ARCHITECT", abstract: "Multi-agent coordination protocol with sigma-variable load balancing.", size: "8pp", doi: "10.48550/TSL.BP.015", citations: 0, downloads: 145, keywords: ["agent swarm", "orchestration", "multi-agent", "protocol"], fullAbstract: "We present version 3 of the Agent Swarm Orchestration Protocol (ASOP), a coordination layer for multi-agent AI systems. ASOP introduces sigma-variable load balancing, where each agent's task load is continuously adjusted based on a deviation metric (sigma) that tracks the agent's performance against expected baselines. The protocol supports 8 model families, automatic failover, and real-time task rerouting. Deployed in the Vortex Sales OS with 12 concurrent agents across 4 model providers.", references: 6, status: "OPEN" },
  { kind: "PAPER", title: "Game-Theoretic Analysis of AMM Liquidity Pools under Stress", id: "TSL-2024-009", date: "2025.03.04", authors: "CHAIN WEAVER", abstract: "Game-theoretic framework for analyzing AMM pool behavior under extreme market stress.", size: "16pp", doi: "10.48550/TSL.2024.009", citations: 8, downloads: 312, keywords: ["AMM", "game theory", "DeFi", "liquidity"], fullAbstract: "We present a game-theoretic framework for analyzing automated market maker (AMM) liquidity pool behavior under extreme market stress conditions. Using a Nash equilibrium analysis of liquidity provider (LP) strategies, we show that LPs exhibit strategic withdrawal behavior when impermanent loss exceeds a threshold of 12.4%. We propose a dynamic fee adjustment mechanism that reduces LP withdrawals by 34% during stress events. The framework is validated against 6 months of mainnet data from 3 production AMMs.", references: 41, status: "PUBLISHED" },
  { kind: "PATENT", title: "Adaptive Voice Synthesis with Emotion Transfer", id: "TSL-PT-003", date: "2025.03.18", authors: "NEURAL HAND, SIGNAL TENDER", abstract: "Voice synthesis system that transfers emotional state from speaker to generated voice.", size: "App.", doi: "PATENT-MM-2025-003", citations: 0, downloads: 0, keywords: ["voice synthesis", "emotion", "TTS", "AI"], fullAbstract: "A voice synthesis system that transfers the emotional state of a human speaker to a generated voice output. The system uses a multi-encoder architecture: one encoder captures linguistic content, another captures emotional prosody from the source speaker, and a third generates the target voice identity. The emotional transfer achieves 87.3% accuracy on a human evaluation benchmark. Deployed in the Vortex Sales OS for emotionally-aware voice agents. Patent filed in Myanmar (PATENT-MM-2025-003).", references: 14, status: "PATENTED" },
  { kind: "DATASET", title: "Multi-Model AI Output Quality Benchmark", id: "TSL-DS-005", date: "2025.04.02", authors: "NEURAL HAND", abstract: "Side-by-side quality comparison of 8 AI model families across 5000 prompts.", size: "210MB", doi: "10.48550/TSL.DS.005", citations: 2, downloads: 178, keywords: ["AI models", "benchmark", "quality", "evaluation"], fullAbstract: "A dataset of side-by-side output quality comparisons across 8 AI model families (Zai, Kimi, GPT-5.6, DeepSeek V4, OxAlpha, Google A2A, Omnibridge, and a baseline open-source model). The dataset contains 5,000 prompts across 12 categories (code, creative, reasoning, math, multilingual, summarization, etc.) with human-rated quality scores (1-5) for each model's response. The benchmark enables research into model selection, ensemble strategies, and the sigma-variable compensation framework. Released under CC-BY-SA.", references: 9, status: "OPEN" },
  { kind: "BLUEPRINT", title: "Cross-Chain Bridge Security Audit Framework", id: "TSL-BP-016", date: "2025.04.15", authors: "NULL CIPHER, CHAIN WEAVER", abstract: "Standardized security audit framework for cross-chain bridge protocols.", size: "12pp", doi: "10.48550/TSL.BP.016", citations: 0, downloads: 203, keywords: ["security", "audit", "bridge", "cross-chain"], fullAbstract: "We present a standardized security audit framework for cross-chain bridge protocols. The framework covers: validator set analysis, message-passing verification, signature scheme evaluation, re-entrancy protection, and economic security (slashing conditions). We apply the framework to 7 production bridges, identifying 3 previously unknown medium-severity vulnerabilities. The framework is released as open-source under MIT, with an automated checking tool that runs 47 security tests per bridge contract.", references: 11, status: "OPEN" },
  { kind: "PAPER", title: "Real-Time Anomaly Detection in IoT Sensor Meshes", id: "TSL-2024-010", date: "2025.05.08", authors: "EDGE RUNNER, QUANTUM SEER", abstract: "Edge-compute anomaly detection for 240-node agricultural IoT sensor mesh.", size: "10pp", doi: "10.48550/TSL.2024.010", citations: 6, downloads: 224, keywords: ["IoT", "anomaly detection", "edge computing", "sensors"], fullAbstract: "We present a real-time anomaly detection system for large-scale IoT sensor meshes, deployed on the 240-node Taungoo agricultural sensor network. The system uses an unsupervised isolation forest algorithm running on edge devices (ESP32 + LoRa), achieving 94.2% anomaly detection accuracy with 0.3W power consumption per node. The system processes 8.1M packets/day and identifies sensor failures, environmental anomalies (frost, drought), and potential tampering within 4 seconds of occurrence. The edge-compute approach eliminates cloud dependency, reducing latency by 98% compared to cloud-based detection.", references: 27, status: "PUBLISHED" },
];
