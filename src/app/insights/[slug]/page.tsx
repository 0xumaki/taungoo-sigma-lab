...
const INSIGHTS: Record<string, {
  ...
  "local-language-nlp-myanmar": {
    ...
    tag: "NLP",
    readTime: "11 min",
    abstract: "A tokenizer and adapter stack for Bago-region Myanmar dialects, addressing the low-resource NLP gap with community-authored evaluation sets.",
    ...
    sections: [
      ...
      { heading: "APPROACH", body: "Built a phoneme-aware subword tokenizer that handles Bago dialect variations. Combined with a dialect-adapter fine-tuning protocol using Python and TypeScript. Released the first community-authored eval set: 2,400 sentences annotated by native speakers under a CC-BY-SA license." },
